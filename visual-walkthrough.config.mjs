...
export const visualWalkthroughConfig = {
	...
	pages: [
		...
		registeredPage(
			...
			operationalDesignRisks.accountRegistration
		),
		operationalPage({
		...
		operationalPage({
			...
			group: 'Projects',
			path: '/pages/project-dashboard/import-participants/index.html',
			...
			stateDescription: 'Import-participants workflow captured with the project ID present.',
		...
		operationalPage({
			...
			group: 'Projects',
			path: '/pages/participant-profile/index.html',
			description: 'Participant profile and consent-readiness page.',
			designRisk: operationalDesignRisks.participantProfile,
			stateTitle: 'Participant profile with consent state',
			stateDescription: 'Participant profile captured with the canonical Participant record ID.',
			statePath: operationalPaths.participantProfile,
			waitForText: 'Participant profile',
		}),
		operationalPage({
			id: 'participant-profile-add-consent',
			title: 'Add participant consent',
			group: 'Projects',
			path: '/pages/participant-profile/add-consent/index.html',
			description: 'Add participant consent evidence from a participant profile.',
			designRisk: operationalDesignRisks.participantConsent,
			stateTitle: 'Add consent with participant context',
			stateDescription: 'Add-consent workflow captured with participant and project IDs present.',
			statePath: operationalPaths.addParticipantConsent,
			waitForText: 'Add consent evidence',
		}),
		...studyPages,
	],
};
