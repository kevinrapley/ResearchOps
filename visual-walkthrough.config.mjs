...
export const visualWalkthroughConfig = {
	...
	pages: [
		...
		statefulPage('study-card-sort', 'Prepare card sort', 'Study', '/pages/study/card-sort/index.html', 'Card sort setup page for preparing cards and groups before a session.', 'Card sort setup with study context', 'Card sort setup captured with the canonical Study record ID.', operationalPaths.studyCardSort, 'Prepare card sort'),
		statefulPage('study-tree-test', 'Prepare tree test', 'Study', '/pages/study/tree-test/index.html', 'Tree Test setup page for preparing the navigation tree and participant tasks before a session.', 'Tree Test setup with study context', 'Tree Test setup captured with the canonical Study record ID.', operationalPaths.studyTreeTest, 'Prepare the tree test'),
		studySessionPage,
		...
		statefulPage('study-ethics-risk', 'Ethics and research risk', 'Study', '/pages/study/ethics-risk/index.html', 'Study-scoped ethics and research risk setup page.', 'Ethics and research risk with study context', 'Ethics risk assessment captured with the canonical Study record ID.', operationalPaths.studyEthicsRisk, 'Ethics advice needed'),
		statefulPage('study-ethics-risk-next-steps', 'Ethics risk next steps', 'Study', '/pages/study/ethics-risk/next-steps/index.html', 'Route-specific follow-up workflow for ethics risk escalation outcomes.', 'Ethics advice next steps', 'Ethics advice workflow captured after the study risk assessment has been recorded.', operationalPaths.studyEthicsRiskNextSteps, 'Ethics advice needed'),
