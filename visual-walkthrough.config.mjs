...
export const visualWalkthroughConfig = {
	...
	pages: [
		...
		statefulPage(
			...
			'/pages/account/index.html',
			'Welcome, Team Admin. Here is your account dashboard'
		),
		...
		registeredPage('start', 'Start research project', 'Core', '/pages/start/index.html', 'Start page for creating or beginning research project work.'),
		...
		statefulPage('project-dashboard-add-participant', 'Add participant', 'Projects', '/pages/project-dashboard/participants/index.html', 'Add a study-linked participant from the project dashboard action workflow.', 'Add participant with parent project context', 'Participant workflow captured with the project ID present.', '/pages/project-dashboard/participants/index.html', 'Add participant'),
		statefulPage('project-dashboard-import-participants', 'Import participants', 'Projects', '/pages/project-dashboard/participants/import/index.html', 'Import study-linked participants from CSV.', 'Import participants with parent project context', 'CSV import workflow captured with the project ID present.', '/pages/project-dashboard/participants/import/index.html', 'Import participants'),
		...
		statefulPage('study-participants', 'Participants', 'Study', '/pages/study/participants/index.html', 'Participants page for a study.', 'Study participants with participant records', 'Participants page captured with the canonical Study record ID.', '/pages/study/participants/index.html', 'Participants'),
		...
		statefulPage('team-role-assignments', 'Assign a role to a team member', 'Team administration', '/pages/team/role-assignments/index.html', 'Team Admin role assignment page.', 'Role assignment form with Team Admin scope', 'Role assignment page captured with a deterministic Team Admin context.', '/pages/team/role-assignments/index.html', 'You can assign roles in teams you manage'),
