...
VALUES
	(
		...
		'{"id":"recdMo80h1QaNQCBk","airtableId":"recdMo80h1QaNQCBk","recordId":"recdMo80h1QaNQCBk","name":"Third Country National Discovery","description":"The Third Country National (TCN) Discovery is a Home Office Digital research and analysis phase focused on understanding and improving how criminal conviction data about non-EU nationals is identified, accessed, and shared between the UK and EU. It supports the UK''s potential participation in the ECRIS-TCN system, which enables member states to identify where conviction data is held for third country nationals.","createdAt":"2026-06-24T10:10:00.000Z","rops:servicePhase":"Discovery","rops:projectStatus":"Goal setting & problem defining","objectives":["1. Understand the problem space\n- Establish a shared understanding of the TCN problem\n- Define the problem statement, goals, and assumptions\n- Align stakeholders on the scope and purpose of Discovery","2. Build an \"As-Is\" view of the current system\n- Map end-to-end workflows (UK <-> EU)\n- Identify systems involved (e.g., LEDS, HOB, ACRO)\n- Understand data flows and formats\n- Capture process steps, timings, and responsibilities","3. Identify users, stakeholders, and impacts\n- Understand who uses TCN data (direct and indirect users)\n- Map organisations involved across policing, borders, and justice\n- Assess who will be impacted by change"],"user_groups":["Law enforcement","ACRO","Borders and immigration","Justice and legal","Indirect operational users","Technical and data users","Policy and governance users"],"stakeholders":[{"name":"Stakeholder One","role":"PSG - ILEC - Criminal Records Team","email":"stakeholder.one@example.test"},{"name":"Stakeholder Two","role":"PSG - ILEC - Criminal Records Team","email":"stakeholder.two@example.test"},{"name":"Stakeholder Three","role":"PSG - ILEC - Criminal Records Team","email":"stakeholder.three@example.test"}],"lead_researcher":"Research Lead One","lead_researcher_email":"research.lead.one@example.test","team_ids":["team_daas"],"teamIds":["team_daas"],"teamNames":["DaaS"],"teamName":"DaaS","team_name":"DaaS","team":"DaaS","org":"DaaS"}'
	)
ON CONFLICT(id) DO UPDATE SET
	name = excluded.name,
	org = excluded.org,
