...
export const DESC_SYSTEM_PROMPT = [
	...
	"Section format (mandatory): Each section must use exactly this layout: Line 1: Section label followed by a colon, with no text after the colon. Line 2+: Content for that section. One blank line before the next label. Never place content on the same line as the label.",
