export default {
	async fetch(request, env, ctx) {
		...
		// --- Enforce CORS allowlist for browsers (non-browser clients can omit Origin)
		...
		if (url.pathname === "/api/projects" && request.method === "POST") {
			...
			if (env.AUDIT === "true") {
				try { console.log("project.created", { name: fields.Name, phase: fields.Phase, status: fields.Status }); } catch {}
			}
