...
function buildHomeAcceptanceCriteria() {
	return [
		...
		'',
		'  Scenario: Know where to start',
		'    Then I should see guidance that says "New to ResearchOps? Start by creating a research project."',
		'    And I should understand that a project gives me somewhere to hold studies, participants, sessions, notes, evidence, insights and recommendations',
		'    And creating a research project should be presented as the first meaningful action',
		'',
		...
		'    And I should see an explanation that ResearchOps follows the shape of a user research project',
		'    And I should understand that I should start by creating a project',
		'    And I should understand that later stages become useful once a project has been created',
		'',
		'  Scenario: View the lifecycle sequence',
		...
		'    Then lifecycle stages should not appear as links unless they open a valid journey for my current context',
		'    And later lifecycle stages should not be presented as primary calls to action',
		'    And the lifecycle should support orientation rather than behave like a menu',
		'',
