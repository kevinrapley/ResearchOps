...
function renderArtefact(target, artefact) {
	...
	list.append(
		...
		summaryRow("Impact record", artefact.impactSource?.impactRecordId),
		summaryRow("Impact context", artefact.impactSource?.impactSummary),
		summaryRow("Decision context", artefact.impactSource?.decisionSummary),
		summaryRow("Outcome context", artefact.impactSource?.outcomeSummary),
