...
- The generator now writes category pages such as `source/modes/index.html`, `source/roles/index.html`, `source/references/index.html`, `source/contracts/index.html`, `source/graders/index.html`, `source/templates/index.html` and `source/scripts/index.html`.
...
- Updated generated metadata to describe the category source panel model.
