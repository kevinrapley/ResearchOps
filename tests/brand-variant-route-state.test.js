...
assert.equal(brandStylesSource.includes('$govuk-tag-purple-background'), false);
assert.equal(brandStylesSource.includes('$govuk-tag-purple-text'), false);
assert.equal(brandStylesSource.includes('.govuk-phase-banner__content__tag'), false);
assert.equal(brandStylesSource.includes('.govuk-phase-banner .govuk-tag'), false);
assert.ok(brandStylesSource.includes('.govuk-tag'));
assert.ok(brandStylesSource.includes('font-size: 1rem'));
assert.ok(brandStylesSource.includes('line-height: 1.25'));
...
assert.equal(brandStyles.includes('#dbd5e9'), false);
assert.equal(brandStyles.includes('#3d2375'), false);
assert.equal(brandStyles.includes('html[data-researchops-brand=home-office] .govuk-phase-banner__content__tag'), false);
assert.ok(brandStyles.includes('--govuk-brand-colour: #732282'));
assert.ok(brandStyles.includes('html[data-researchops-brand=home-office] .govuk-tag'));
assert.ok(brandStyles.includes('font-size: 1rem'));
assert.ok(brandStyles.includes('line-height: 1.25'));
