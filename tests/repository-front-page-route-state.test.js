...
has(files.staticTemplate, 'repository-selected-summary', 'static repository template');
...
has(files.service, 'function selectedFacet', 'service');
has(files.service, 'function pagination', 'service');
has(files.service, 'pagination: { page: pager.page, limit: pager.limit, total }', 'service');
has(files.service, 'selected: selectedFacet(url)', 'service');
...
has(files.stylesheet, '.repository-browse-list__button--selected', 'stylesheet');
has(files.stylesheet, '.repository-selected-state', 'stylesheet');
has(files.stylesheet, '.repository-result-meta', 'stylesheet');
has(files.stylesheet, '.repository-pagination', 'stylesheet');
