...
const buildGeneratedCssSource = fs.readFileSync("scripts/styles/build-generated-css.mjs", "utf8");
...
includes(pageSource, "/pages/study/study-desc-controller.js", "study page");
...
includes(studyScssSource, "Source:     /src/styles/study-page.scss", "study SCSS source");
includes(studyScssSource, "Output:     /public/css/study-page.css", "study SCSS source");
...
includes(packageSource, "build:study-page", "package build scripts");
includes(packageSource, "node scripts/styles/build-generated-css.mjs public/css/study-page.css", "package build scripts");
...
includes(buildGeneratedCssSource, "generatedCssPaths", "generated CSS builder");
includes(buildGeneratedCssSource, "commitGeneratedCssIfNeeded", "generated CSS builder");
includes(buildGeneratedCssSource, "process.env.GITHUB_WORKFLOW !== 'Format pull request'", "generated CSS builder");
includes(buildGeneratedCssSource, "chore: update generated CSS", "generated CSS builder");
includes(gitignoreSource, "!public/css/study-page.css", "gitignore generated CSS allowlist");
