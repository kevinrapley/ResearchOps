...
includes(studyCssSource, ".dashboard-hero .govuk-heading-l", "study css");
includes(studyCssSource, "font-size: 32px;", "study css");
includes(studyCssSource, "overflow-wrap: anywhere;", "study css");
includes(studyCssSource, ".actions-bar .govuk-button", "study css");
includes(studyCssSource, "width: 100%;", "study css");
includes(studyCssSource, ".readiness-item__header", "study css");
includes(studyCssSource, "grid-template-columns: minmax(0, 1fr);", "study css");
