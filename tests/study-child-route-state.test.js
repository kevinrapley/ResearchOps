...
for (const [label, source] of Object.entries(pages)) {
	if (label === "guides") {
		...
		includes(source, "?v=study-synthesis-20260701-codex-comment-fixes", label);
	} else {
...
includes(pages.synthesis, "/js/synthesis-route-loader.js?v=study-synthesis-20260701-codex-comment-fixes", "synthesis page");
...
includes(loaders.synthesis, "await import('/js/synthesize-page.js?v=study-synthesis-20260701-codex-comment-fixes')", "synthesis loader");
