...
includes(stylesheetScssSource, '.outcomes-guidance-panel--sticky', 'outcomes SCSS source');
includes(stylesheetScssSource, '.impact-reference-row', 'outcomes SCSS source');
includes(stylesheetScssSource, '.impact-reference-copy-status', 'outcomes SCSS source');
includes(stylesheetScssSource, '.outcomes-form [hidden]', 'outcomes SCSS source');
...
includes(controllerSource, 'arrangeReferenceControls', 'outcomes controller');
includes(controllerSource, 'impact-reference-copy-status', 'outcomes controller');
includes(controllerSource, 'outcomes-guidance-panel--sticky', 'outcomes controller');
includes(controllerSource, 'cancelImpactEdit', 'outcomes controller');
...
excludes(controllerSource, 'panel.style.top = \'96px\'', 'outcomes controller');
...
includes(impactTrackerSource, 'setCancelEditVisible', 'impact tracker cancel edit');
includes(impactTrackerSource, 'function cancelEdit', 'impact tracker cancel edit');
includes(impactTrackerSource, 'copyStatus', 'impact tracker copy status');
