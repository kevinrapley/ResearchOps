...
includes(caqdas, "function cooccurrenceHeatmapCodes(rows, limit = 5)", "CAQDAS co-occurrence renderer");
includes(caqdas, "cooccurrenceHeatmapCodes(rows, 5)", "CAQDAS co-occurrence renderer");
includes(caqdas, "Showing weights between 5 connected high-weight codes.", "CAQDAS co-occurrence renderer");
includes(caqdas, 'style="table-layout: fixed; width: 100%; min-width: 42rem;"', "CAQDAS co-occurrence renderer");
includes(caqdas, "padding-right: 1rem", "CAQDAS co-occurrence renderer");
