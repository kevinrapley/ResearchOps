...
const patternControllerSource = fs.readFileSync("public/components/guides/pattern-controller.js", "utf8");
const guidesApiSource = fs.readFileSync("public/components/guides/api.js", "utf8");
const frontMatterSource = fs.readFileSync("public/components/guides/front-matter.js", "utf8");
...
includes(guidesPageSource, "createPatternController", "guides component module");
includes(guidesPageSource, "fetchJSON, loadStudies", "guides component module");
includes(guidesPageSource, "extractAndStripFrontMatter", "guides component module");
includes(guidesPageSource, "parseSimpleYaml", "guides component module");
includes(guidesPageSource, "stripFrontMatter", "guides component module");
...
includes(guidesApiSource, "export async function fetchJSON", "guides API module");
includes(guidesApiSource, "export async function loadStudies", "guides API module");
includes(frontMatterSource, "export function stripFrontMatter", "guides front matter module");
includes(frontMatterSource, "export function parseSimpleYaml", "guides front matter module");
...
includes(patternControllerSource, "function viewLocalPattern", "pattern controller module");
includes(patternControllerSource, "function editLocalPattern", "pattern controller module");
includes(patternControllerSource, "function deleteLocalPattern", "pattern controller module");
includes(patternControllerSource, "function formatPatternCategory", "pattern controller module");
includes(patternControllerSource, "function patternPartialName", "pattern controller module");
includes(patternControllerSource, "function setCreatePatternVisibility", "pattern controller module");
includes(patternControllerSource, "patternServiceAvailable = true", "pattern controller module");
includes(patternControllerSource, "patternServiceAvailable = false", "pattern controller module");
includes(patternControllerSource, "setCreatePatternVisibility(true)", "pattern controller module");
includes(patternControllerSource, "setCreatePatternVisibility(false)", "pattern controller module");
includes(patternControllerSource, "if (!patternServiceAvailable) return", "pattern controller module");
includes(patternControllerSource, "patternItem.appendChild(tray)", "pattern controller module");
includes(patternControllerSource, "function bindPatternListActions", "pattern controller module");
includes(patternControllerSource, "window.__researchOpsHandlePatternClick = handlePatternClick", "pattern controller module");
includes(patternControllerSource, "pattern-action-button", "pattern controller module");
includes(patternControllerSource, "data-view=", "pattern controller module");
includes(patternControllerSource, "data-edit=", "pattern controller module");
includes(patternControllerSource, "data-delete=", "pattern controller module");
includes(patternControllerSource, "govuk-button--warning pattern-action-button", "pattern controller module");
includes(patternControllerSource, "Add to guide", "pattern controller module");
excludes(patternControllerSource, "const insertName = `${p.name}_v${p.version}`", "pattern controller module");
excludes(patternControllerSource, "${escapeHtml(pattern.name)}_v${escapeHtml(pattern.version)}", "pattern controller module");
includes(patternControllerSource, "data-save-local-pattern", "pattern controller module");
includes(patternControllerSource, "data-confirm-delete-local-pattern", "pattern controller module");
includes(patternControllerSource, "Confirm deletion", "pattern controller module");
includes(patternControllerSource, "Type <strong>delete pattern</strong>", "pattern controller module");
includes(patternControllerSource, "data-delete-pattern-confirmation", "pattern controller module");
includes(patternControllerSource, "disabled>Delete pattern</button>", "pattern controller module");
includes(patternControllerSource, "input.value.trim() !== 'delete pattern'", "pattern controller module");
includes(patternControllerSource, "Type \"delete pattern\" before deleting this pattern", "pattern controller module");
includes(patternControllerSource, "pattern-tray", "pattern controller module");
includes(patternControllerSource, "govuk-warning-text", "pattern controller module");
includes(patternControllerSource, "Add to guide", "pattern controller module");
