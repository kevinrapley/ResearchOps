...
includes(pageSource, "rel=\"modulepreload\" href=\"/components/session-controller.js?v=", "study session page");
includes(pageSource, "rel=\"modulepreload\" href=\"/components/session-consent-controller.js?v=", "study session page");
includes(pageSource, "src=\"/components/session-controller.js?v=", "study session page");
includes(pageSource, "src=\"/components/session-consent-controller.js?v=", "study session page");
includes(pageSource, "href=\"/css/study-session.css?v=", "study session page");
...
includes(pageSource, "id=\"note-input\"", "study session page");
includes(pageSource, "class=\"govuk-textarea\"", "study session page");
includes(pageSource, "id=\"framework\"", "study session page");
includes(pageSource, "id=\"note-kind\"", "study session page");
includes(pageSource, "id=\"note-shortcuts\"", "study session page");
includes(pageSource, "id=\"note-filters\"", "study session page");
includes(pageSource, "id=\"btn-export-notes\"", "study session page");
includes(pageSource, "class=\"study-session-capture\"", "study session page");
includes(pageSource, "class=\"govuk-details__summary-text\"", "study session page");
includes(pageSource, "Participant details", "study session page");
includes(pageSource, "Consent summary", "study session page");
...
excludes(pageSource, "id=\"note-editor\"", "study session page");
excludes(pageSource, "id=\"note-search\"", "study session page");
excludes(pageSource, "class=\"study-session-editor-shell\"", "study session page");
excludes(pageSource, "role=\"toolbar\" aria-label=\"Formatting\"", "study session page");
...
includes(sessionTemplateSource, "govuk/components/textarea/macro.njk", "study session template");
includes(sessionTemplateSource, "govuk/components/details/macro.njk", "study session template");
includes(sessionTemplateSource, "govuk/components/warning-text/macro.njk", "study session template");
...
includes(controllerSource, "note-input", "session controller");
...
includes(controllerSource, "session_airtable_id", "session controller");
includes(controllerSource, "content_html", "session controller");
...
excludes(controllerSource, "url.searchParams.get(\"sid\")", "session controller");
excludes(controllerSource, "legacyStudySessionId", "session controller");
includes(controllerSource, "const FRAMEWORKS", "session controller");
includes(controllerSource, "FIELDNOTES_CATEGORIES", "session controller");
includes(controllerSource, "prefixPattern", "session controller");
includes(controllerSource, "mapApiNote", "session controller");
includes(controllerSource, "hydrateBreadcrumbs", "session controller");
includes(controllerSource, "govuk-summary-list__row", "session controller");
includes(controllerSource, "section.hidden=notes.length===0", "session controller");
...
excludes(controllerSource, "note-search", "session controller");
...
includes(consentControllerSource, "params.get(\"id\")", "session consent controller");
...
includes(consentControllerSource, "params.get(\"project\")", "session consent controller");
excludes(consentControllerSource, "params.get(\"sid\")", "session consent controller");
excludes(consentControllerSource, "params.get(\"pid\")", "session consent controller");
