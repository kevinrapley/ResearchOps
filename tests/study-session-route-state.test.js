...
includes(legacySessionsControllerSource, "function parseWholeNumber", "legacy sessions controller");
includes(legacySessionsControllerSource, "function validateSessionDateTime", "legacy sessions controller");
includes(legacySessionsControllerSource, "function composeSessionStartIso", "legacy sessions controller");
includes(legacySessionsControllerSource, "return result.valid ? result.iso : null", "legacy sessions controller");
...
includes(legacySessionsControllerSource, "Enter a complete date.", "legacy sessions controller");
includes(legacySessionsControllerSource, "Enter a real date and time.", "legacy sessions controller");
includes(legacySessionsControllerSource, "Enter an hour between 0 and 23.", "legacy sessions controller");
includes(legacySessionsControllerSource, "Enter minutes between 0 and 59.", "legacy sessions controller");
...
includes(legacySessionsControllerSource, "if (!sessionStart.valid)", "legacy sessions controller");
