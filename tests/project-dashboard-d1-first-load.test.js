...
assert.ok(templateSource.includes("project-dashboard-mural-optional-20260526"));
assert.equal(templateSource.includes("projects-api-proxy-20260514"), false);
assert.ok(previewWorkerWorkflow.includes(".passwordless-preview.secrets.json"));
