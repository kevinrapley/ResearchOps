...
includes(serviceSource, "widgetPayloadFromTemplate", "service");
includes(serviceSource, "patchPayloadFromTemplate", "service");
includes(serviceSource, "createWidgetFromTemplate", "service");
includes(serviceSource, "updateTemplateWidget", "service");
includes(serviceSource, "updated-template-widget", "service");
includes(serviceSource, "created-template-widget", "service");
includes(serviceSource, "createdOrUpdated", "service");
includes(serviceSource, "function hydrateReason", "service");
includes(serviceSource, "template-minimal-array", "service");
