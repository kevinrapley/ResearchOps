...
includes(pageSource, "class=\"dashboard-section\"", "project dashboard page");
includes(pageSource, "class=\"dashboard-section__header\"", "project dashboard page");
includes(pageSource, "class=\"dashboard-section__title govuk-heading-m\"", "project dashboard page");
includes(pageSource, "class=\"dashboard-section__body dashboard-section__grid\"", "project dashboard page");
excludes(pageSource, "class=\"section\"", "project dashboard page");
excludes(pageSource, "class=\"section__header\"", "project dashboard page");
excludes(pageSource, "class=\"section__title govuk-heading-m\"", "project dashboard page");
excludes(pageSource, "class=\"section__body section__grid\"", "project dashboard page");
...
includes(dashboardCssSource, ".dashboard-section", "project dashboard stylesheet");
includes(dashboardCssSource, ".dashboard-section__header", "project dashboard stylesheet");
includes(dashboardCssSource, ".dashboard-section__body", "project dashboard stylesheet");
includes(dashboardCssSource, ".dashboard-section__grid", "project dashboard stylesheet");
