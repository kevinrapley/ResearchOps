...
includes(muralIntegrationSource, "User-initiated Project Dashboard", "Mural integration component");
includes(muralIntegrationSource, "function wireConnectButton", "Mural integration component");
